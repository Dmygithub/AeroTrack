...
# torch.compiler.is_dynamo_compiling() was added in PyTorch 2.3.
# Patch torch.compiler for PyTorch 2.1/2.2 compatibility.
import torch as _torch
if not hasattr(_torch.compiler, "is_dynamo_compiling"):
    _torch.compiler.is_dynamo_compiling = lambda: _torch._dynamo.is_compiling()
