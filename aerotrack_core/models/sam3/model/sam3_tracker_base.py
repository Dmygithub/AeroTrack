...
from aerotrack_core.models.sam3.model.memory import SimpleMaskEncoder

from aerotrack_core.models.sam3.model.sam3_tracker_utils import get_1d_sine_pe, select_closest_cond_frames

from aerotrack_core.models.sam3.sam.mask_decoder import MaskDecoder, MLP
from aerotrack_core.models.sam3.sam.prompt_encoder import PromptEncoder
from aerotrack_core.models.sam3.sam.transformer import TwoWayTransformer
from aerotrack_core.models.sam3.train.data.collator import BatchedDatapoint
...
class Sam3TrackerBase(torch.nn.Module):
    ...
    def _apply_non_overlapping_constraints(self, pred_masks):
        ...
        # Use masked_fill_ for true zero-copy in-place suppression.
        # Unlike `pred_masks[mask] = pred_masks[mask].clamp(...)`, masked_fill_
        # does NOT materialise any intermediate tensor, eliminating the OOM
        # that occurred when suppress covers a large fraction of a high-res frame.
        suppress = ~keep
        pred_masks.masked_fill_(suppress, -10.0)
        return pred_masks
    ...
    def _compile_all_components(self):
        ...
        from aerotrack_core.models.sam3.perflib.compile import compile_wrapper
