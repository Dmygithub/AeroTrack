...
# torch.nn.attention (sdpa_kernel / SDPBackend) was introduced in PyTorch 2.3.
# Fall back to the legacy torch.backends.cuda.sdp_kernel for PyTorch 2.1/2.2.
try:
    ...
    def sdpa_kernel(backends):
        ...
        enable_mem = SDPBackend.EFFICIENT_ATTENTION in backends
